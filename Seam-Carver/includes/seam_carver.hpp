...
public:
  // default constructor
  //
  // Not tested, but you are welcome to initialize (or not) member variables
...
private:
   ...
   * Add any helper methods you may need
   */
  // updates the energy array for vertical seam calculations
  void UpdateVertEnergyArray(int** energy_array) const;

  // updates the energy array for horizontal seam calculations
  void UpdateHorizEnergyArray(int** energy_array) const;

  // finds the vertical seam with minimum energy
  int* FindVertMinSeam(int** energy_array) const;

  // finds the horizontal seam with minimum energy
  int* FindHorizMinSeam(int** energy_array) const;
};
